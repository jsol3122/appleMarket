...
function get_detail(DTO){
  ...
  "<div class=row>"+
      "<div class=product_pictures>"+
          ...
          "<ul class=thumb_img>"+
              "<li class=active>"+
                  "<img src='/appleMarket/storage/"+DTO.buyerboard_image1+"' style=width:57px;height:57px; data-target="+DTO.buyerboard_image1+" alt=상세사진1>"+
              "</li>"+
              "<li class=''>"+
                  "<img src='/appleMarket/storage/"+DTO.buyerboard_image2+"' style=width:57px;height:57px; data-target="+DTO.buyerboard_image2+" alt=상세사진2>"+
              "</li>"+
          "</ul>"+
      "</div>"+
