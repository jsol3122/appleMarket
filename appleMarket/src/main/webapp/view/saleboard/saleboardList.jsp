            ...
            <div class="list_filters">
                <div class="combi_filters">
                    <div class="category_filter" data-filter-group="category">
                        <h3>카테고리</h3>
                        <input type="checkbox" id="sale_category_all" name="sale_category_all" value="*" onclick='getCheckboxValue(event)' checked>
                        <span class="box">box</span>
                        <label for="sale_category_all">All</label>
                        <input type="checkbox" id="tech" name="sale_category" value="tech"  onclick='getCheckboxValue(event)' checked>
                        <span class="box">box</span>
                        <label for="tech">디지털기기/생활가전</label>

                        <input type="checkbox" id="furniture" name="sale_category" value="furniture"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="furniture">가구/인테리어</label>

                        <input type="checkbox" id="baby" name="sale_category" value="baby"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="baby">유아동</label>

                        <input type="checkbox" id="living" name="sale_category" value="living"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        ...
                        <div class="category_filter" data-filter-group="category">
                        <h3></h3>
                        <input type="checkbox" id="female" name="sale_category" value="female"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="female">여성패션/잡화</label>
                        
                        <input type="checkbox" id="male" name="sale_category" value="male"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="male">남성패션/잡화</label>
                        
                        <input type="checkbox" id="hobby" name="sale_category" value="hobby"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="hobby">게임/취미</label>
                        
                        <input type="checkbox" id="sports" name="sale_category" value="sports"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        ...
                        <div class="category_filter" data-filter-group="category">
                        <h3></h3>
                        <input type="checkbox" id="beauty" name="sale_category" value="beauty"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="beauty">뷰티/미용</label>
                        
                        <input type="checkbox" id="pet" name="sale_category" value="pet"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="pet">반려동물용품</label>
                        
                        <input type="checkbox" id="book" name="sale_category" value="book"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
                        <label for="book">도시/티켓/음반</label>
                        
                        <input type="checkbox" id="etc" name="sale_category" value="etc"  onclick='getCheckboxValue(event)'>
                        <span class="box">box</span>
