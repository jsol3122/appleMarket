...
<body>
    <%@include file="/includes/header.jsp" %>
		<div class="row">
		    ...
		    <div class="col-md-8" style="margin-top: 100px;">
		        ...
		        <form id="localCommunityModifyForm">
		          <table class="table table-striped">
		          <input type="hidden" name="localcommunity_seq" id="localcommunity_seq" value=""/>
		            <tr>
		                <td>아이디</td>
		                <td><input type="text"  value="${member_id}" class="form-control" name="localcommunity_user_id" readonly></td>
		            </tr>
		            <tr>
		                <td>제목</td>
		                <td><input type="text"  class="form-control" name="localcommunity_subject"></td>
		            </tr>
		            <tr>
		                <td>글내용</td>
		                <td><textarea rows="10" cols="50" name="localcommunity_content" class="form-control"></textarea></td>
		            </tr>
		            <tr>
		                 
		                <td colspan="2"  class="text-center">
		                    <input type="button" value="수정완료" class="btn btn-success">
    ...
    <script src="/appleMarket/js/localCommunityboardModify.js"></script>
