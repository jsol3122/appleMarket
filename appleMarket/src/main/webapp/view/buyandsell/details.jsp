        ...
        <div class="container">
            <div class="row">
                <div class="product_pictures col-md-5">
                    <img src="/appleMarket/img/ware/에어팟1-1.jpg" style="width: 300px; height: 245px;" alt="coat" class="big_img">
                    <ul class="thumb_img">
                        <li class="active"><img src="/appleMarket/img/ware/에어팟1-1.jpg" style="width: 30px; height: 57px;" data-target="에어팟1-1.jpg" alt=""></li>
                        <li><img src="/appleMarket/img/ware/에어팟1-2.jpg" style="width: 30px; height: 57px;" data-target="에어팟1-2.jpg" alt=""></li>
                        <li><img src="/appleMarket/img/ware/에어팟1-3.jpg" style="width: 30px; height: 57px;" data-target="에어팟1-3.jpg" alt=""></li>
                    </ul>
                </div>
