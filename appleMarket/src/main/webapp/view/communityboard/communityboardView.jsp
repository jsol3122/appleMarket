                                                        ...
                                                        <form class="bd_wrt cmt_wrt clear" editor_sequence="668947"><input type="hidden" name="error_return_url" value="/index.php?mid=freebd&amp;sort_index=readed_count&amp;order_type=desc&amp;document_srl=668947"><input type="hidden" name="act" value="">
                                                            ...
                                                            <div class="simple_wrt">
                                                                <div class="text">
                                                                    ...
                                                                    <input type="hidden" name="communityboard_seq" id="communityboard_seq" value="">
                                                                    <textarea id="editor_668947" name="communityboard_comment_content" cols="50" rows="4" style="overflow: hidden; min-height: 4em; height: 46px; width: 100%;"></textarea>
