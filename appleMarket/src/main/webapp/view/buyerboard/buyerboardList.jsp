            ...
            <div class="list_filters">
                <div class="combi_filters">
                    <div class="category_filter" data-filter-group="category">
                        ...
                        <input type="checkbox" id="buyerboard_category_all" name="buyerboard_category" value="*" onclick='getCheckboxValue(event)' autocomplete="off" checked/>
                        <span class="box">box</span>
                        <label for="buyerboard_category_all">All</label>

                        <input type="checkbox" id="tech" name="buyerboard_category" value="tech" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="tech">디지털기기/생활가전</label>

                        <input type="checkbox" id="furniture" name="buyerboard_category" value="furniture" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="furniture">가구/인테리어</label>

                        <input type="checkbox" id="baby" name="buyerboard_category" value="baby" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="baby">유아동</label>

                        <input type="checkbox" id="living" name="buyerboard_category" value="living" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="living">생활/가공식품</label>
                        
                        <input type="checkbox" id="female" name="buyerboard_category" value="female" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="female">여성패션/잡화</label>
                        
                        <input type="checkbox" id="male" name="buyerboard_category" value="male" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="male">남성패션/잡화</label>
                        
                        <input type="checkbox" id="hobby" name="buyerboard_category" value="hobby" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="hobby">게임/취미</label>
                        
                        <input type="checkbox" id="sports" name="buyerboard_category" value="sports" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="sports">스포츠/레저</label>
                        
                        <input type="checkbox" id="beauty" name="buyerboard_category" value="beauty" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="beauty">뷰티/미용</label>
                        
                        <input type="checkbox" id="pet" name="buyerboard_category" value="pet" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="pet">반려동물용품</label>
                        
                        <input type="checkbox" id="book" name="buyerboard_category" value="book" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
                        <label for="book">도시/티켓/음반</label>
                        
                        <input type="checkbox" id="etc" name="buyerboard_category" value="etc" onclick='getCheckboxValue(event)' autocomplete="off"/>
                        <span class="box">box</span>
